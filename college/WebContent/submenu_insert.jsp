							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										...
										<form role="form" action="SubMenuServlet?flag=insert"
											...
											<div class="form-group col-xs-6">
												...
												<c:forEach items="${menus }" var="m">
												   <option value="${m.id }">${m.title }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${m.type}</span></option>
												</c:forEach>
												</select>
												...
												<button type="submit" class="btn btn-info" style="margin-top:20px;">新增</button>
											</div>
										</form>
									</div>
								</div>
